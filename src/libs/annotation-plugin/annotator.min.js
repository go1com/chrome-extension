...
*/
((function () {
  var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y = [].slice, z = {}.hasOwnProperty,
    A = function (a, b) {
      function d() {
        this.constructor = a
      }
  ...
  n = function (b) {
    ...
    return b
  }, m = null, typeof Gettext != "undefined" && Gettext !== null ? (q = new Gettext({domain: "annotator"}), m = function (a) {
    return q.gettext(a)
  }) : m = function (a) {
    return a
  }, x = function (a) {
    ...
    try {
      ...
      c = e, console.log("jQuery-based XPath construction failed! Falling back to manual."), d = o.call(a, b)
    }
    return d
  }, f.nodeFromXPath = function (a, b) {
    var c, d, e, f, h, i, j, k;
    h = a.substring(1).split("/"), e = b;
    for (i = 0, j = h.length; i < j; i++) f = h[i], k = f.split("["), d = k[0], c = k[1], c = c != null ? parseInt((c != null ? c.split("]") : void 0)[0]) : 1, e = g(e, d.toLowerCase(), c);
    return e
  }, f.escape = function (a) {
  ...
  }, i = ["log", "debug", "info", "warn", "exception", "assert", "dir", "dirxml", "trace", "group", "groupEnd", "groupCollapsed", "time", "timeEnd", "profile", "profileEnd", "count", "clear", "table", "error", "notifyFirebug", "firebug", "userObjects"];
  if (typeof console != "undefined" && console !== null) {
    ...
    for (r = 0, t = i.length; r < t; r++) h = i[r], console[h] == null && (console[h] = function () {
      return console.log(x("Not implemented:") + (" console." + name))
    })
  } else {
    this.console = {};
    for (s = 0, u = i.length; s < u; s++) h = i[s], this.console[h] = function () {
    };
    this.console.error = function () {
      var a;
      return a = 1 <= arguments.length ? y.call(arguments, 0) : [], alert("ERROR: " + a.join(", "))
    }, this.console.warn = function () {
      var a;
      return a = 1 <= arguments.length ? y.call(arguments, 0) : [], alert("WARNING: " + a.join(", "))
    }
  }
  c = function () {
    function b(b, c) {
    ...
    return b.prototype.events = {}, b.prototype.options = {}, b.prototype.element = null, b.prototype.addEvents = function () {
      var a, b, c, d, e, f, g, h;
      f = this.events, h = [];
      for (c in f) b = f[c], g = c.split(" "), d = 2 <= g.length ? y.call(g, 0, e = g.length - 1) : (e = 0, []), a = g[e++], h.push(this.addEvent(d.join(" "), a, b));
      return h
    ...
    return b = function () {
      ...
      for (a in b) {
        if (!z.call(b, a)) continue;
        c = b[a], d.push(a)
      }
      return d
    }(), "blur focus focusin focusout load resize scroll unload click dblclick\nmousedown mouseup mousemove mouseover mouseout mouseenter mouseleave\nchange select submit keydown keypress keyup error".split(/[^a-z]+/).concat(b)
  }(), e = {}, e.sniff = function (a) {
    return a.commonAncestorContainer != null ? new e.BrowserRange(a) : typeof a.start == "string" ? new e.SerializedRange(a) : a.start && typeof a.start == "object" ? new e.NormalizedRange(a) : (console.error(x("Could not sniff range type")), !1)
    ...
    return a.prototype.normalize = function (a) {
      ...
      if (this.tainted) return console.error(x("You may only call normalize() once on a BrowserRange!")), !1;
    ...
    return A(c, b), c.prototype.events = {
      ".annotator-adder button click": "onAdderClick",
      ".annotator-adder button mousedown": "onAdderMousedown",
      ".annotator-hl mouseover": "onHighlightMouseover",
      ".annotator-hl mouseout": "startViewerHideTimer"
    }, c.prototype.html = {
      adder: '<div class="annotator-adder"><button>' + x("Annotate") + "</button></div>",
      wrapper: '<div class="annotator-wrapper"></div>'
    }, c.prototype.options = {readOnly: !1}, c.prototype.plugins = {}, c.prototype.editor = null, c.prototype.viewer = null, c.prototype.selectedRanges = null, c.prototype.mouseIsDown = !1, c.prototype.ignoreMouseup = !1, c.prototype.viewerHideTimer = null, c.prototype._setupWrapper = function () {
      ...
      var b = this;
      return this.viewer = new c.Viewer({readOnly: this.options.readOnly}), this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({
        load: function (c, d) {
          return d.text ? a(c).html(f.escape(d.text)) : a(c).html("<i>" + x("No Comment") + "</i>"), b.publish("annotationViewerTextField", [c, d])
        }
      ...
      return this.plugins.Store ? this.plugins.Store.dumpAnnotations() : (console.warn(x("Can't dump annotations without Store plugin.")), !1)
    ...
    return A(b, a), b.prototype.pluginInit = function () {
    }, b
  }(c), j = f.getGlobal(), ((w = j.document) != null ? w.evaluate : void 0) == null && a.getScript("http://assets.annotateit.org/vendor/xpath.min.js"), j.getSelection == null && a.getScript("http://assets.annotateit.org/vendor/ierange.min.js"), j.JSON == null && a.getScript("http://assets.annotateit.org/vendor/json2.min.js"), j.Node == null && (j.Node = {
    ELEMENT_NODE: 1,
    ATTRIBUTE_NODE: 2,
    TEXT_NODE: 3,
    ...
    NOTATION_NODE: 12
  }), b.$ = a, b.Delegator = c, b.Range = e, b.Util = f, b._t = x, b.supported = function () {
    return function () {
      return !!this.getSelection
    }()
  }, b.noConflict = function () {
    return f.getGlobal().Annotator = p, this
    ...
    return A(d, c), d.prototype.classes = {
      hide: "annotator-hide",
    ...
    return A(d, c), d.prototype.events = {
      ...
      var d, e, f;
      e = a.extend({
        id: "annotator-field-" + b.Util.uuid(), type: "input", label: "", load: function () {
        }, submit: function () {
        }
    ...
    function e(b) {
      this.onDeleteClick = B(this.onDeleteClick, this), this.onEditClick = B(this.onEditClick, this), this.load = B(this.load, this), this.hide = B(this.hide, this), this.show = B(this.show, this), e.__super__.constructor.call(this, a(this.html.element)[0], b), this.item = a(this.html.item)[0], this.fields = [], this.annotations = []
    }

    return A(e, c), e.prototype.events = {
    ...
    }, e.prototype.options = {readOnly: !1}, e.prototype.show = function (a) {
      var c, d = this;
      ...
      for (o = 0, q = s.length; o < q; o++) {
        c = s[o], k = a(this.item).clone().appendTo(n).data("annotation", c), f = k.find(".annotator-controls"), l = f.find(".annotator-link"), h = f.find(".annotator-edit"), g = f.find(".annotator-delete"), m = (new d(c.links || [])).get("alternate", {type: "text/html"}), m.length === 0 || m[0].href == null ? l.remove() : l.attr("href", m[0].href), this.options.readOnly ? (h.remove(), g.remove()) : e = {
          showEdit: function () {
    ...
    function d(b) {
      this.hide = B(this.hide, this), this.show = B(this.show, this), d.__super__.constructor.call(this, a(this.options.html).appendTo(document.body)[0], b)
    }

    return A(d, c), d.prototype.events = {click: "hide"}, d.prototype.options = {
