...
var rangy = window['rangy'] || null,
  undo = window['Undo'] || null,
  key = window.Key = {
    'backspace': 8,
    'tab': 9,
    'enter': 13,
  ...
  Medium: any = (function () {
    ...
    Medium.prototype = {
      placeholders: function () {
        ...
        var s = this.settings,
          placeholder = this.placeholder || (this.placeholder = document.createElement('div')),
          el = this.element,
      ...
      setupContents: function () {
        ...
        if (childNodes.length > 0) {
          initialParagraph = document.createElement(s.tags.paragraph);
      ...
      splitAtCaret: function () {
        ...
        var selector = (window.getSelection || document.selection),
          sel = selector(),
    ...
    (function (Medium) {
      ...
      Medium.Drag = function (medium) {
        ...
        var that = this,
          ...
          icon = this.icon = document.createElement('img');
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="21.424px" height="21.424px" viewBox="0 0 21.424 21.424" style="enable-background:new 0 0 21.424 21.424;" xml:space="preserve">\
	<g>\
        ...
        handleDragend: function () {
          ...
          utils.addEvent(this.icon, 'dragend', this.handledEvents.dragend = document.body.ondragend = function (e) {
            if (me.protectedElement === null) return;
        ...
        cleanCanvas: function () {
          var target,
            inserted = false,
            buttons = document.getElementsByClassName(this.buttonClass);
      ...
      Medium.Element.prototype = {
        ...
        invoke: function (fn) {
          if (Medium.activeElement === this.element) {
            ...
            applier.toggleSelection(window);
    ...
    (function (Medium) {
      ...
      Medium.Injector.prototype = {
        ...
        inject: function (htmlRaw) {
          ...
          var wedge = document.getElementById('Medium-wedge'),
    ...
    (function (Medium) {
      ...
      Medium.Toolbar.prototype = {
        ...
        destroy: function () {
          utils
            .removeEvent(window, 'scroll', this.handledEvents.scroll)
            .removeEvent(document, 'mouseup', this.handledEvents.mouseup)
            .removeEvent(document, 'keyup', this.handledEvents.keyup);
        },
        handleScroll: function () {
          var me = this;

          utils.addEvent(window, 'scroll', this.handledEvents.scroll = function () {
            if (me.active) {
              me.goToSelection();
            }
          });
        ...
        handleMouseup: function () {
          ...
          utils.addEvent(document, 'mouseup', this.handledEvents.mouseup = function () {
        ...
        handleKeyup: function () {
          ...
          utils.addEvent(document, 'keyup', this.handledEvents.keyup = function () {
            if (Medium.activeElement === me.medium.element && !me.busy) {
              me.goToSelection();
            }
          });
    ...
    Medium.Utilities = {
      ...
      pasteHook: function (medium, fn) {
        ...
        var tempEditable = document.createElement('div'),
          el = medium.element,
          existingValue,
          existingLength,
          overallLength,
